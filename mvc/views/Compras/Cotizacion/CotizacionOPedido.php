...
<div class="row" id="Listado">
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-body">
                <div id="toolbar">
                    <button addCotizacion class="btn btn-success btn-sm">
                ...
                <table
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-field="fechaFin">Proveedor</th>
                            <th data-field="observacion">Usuario</th>
...
<div class="hidden" id="div-registro">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-5">
                <div class="row">
                    <div class="box box-primary" datos>
                        <div class="box-header with-border">
